...
<div style='width:100%; background-color:black; text-align:center; font-size: 15px; padding: 20px; color:white; border-bottom: 2px solid red;'>MADE BY <br><a href="https://t.me/still_alivenow" ><span style='color:#ff0000;'>  ICHIGO KUROSAKI</span></a></div>
    <div class="app-content content">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body text-center anime">
                                ...
                                <!-- New SK Key and PK Key fields -->
                                <textarea rows="1" class="form-control text-center"
                                    style="width: 50%; float: left; resize:none; overflow:hidden;" id="sk_key"
                                    placeholder="SK KEY HERE"></textarea>
                                <textarea rows="1" class="form-control text-center"
                                    style="width: 50%; float: right; resize:none; overflow:hidden;" id="pk_key"
                                    placeholder="PK KEY HERE"></textarea>
                                
                                <!--<textarea rows="1" class="form-control text-center"
                                    style="width: 70%; float: left; resize:none; overflow:hidden; margin-top: 5px;" id="sec"
                                    placeholder="SEC KEY (Optional)"></textarea>-->
                                <textarea rows="1" class="form-control text-center"
                                    style="width: 100%; float: right; margin-bottom: 5px; margin-top: 5px; resize:none; overflow:hidden;"
                                    id="cst" placeholder="AMOUNT"></textarea>
                                
                                <!-- Telegram Bot Fields -->
                                <textarea rows="1" class="form-control text-center"
                                    style="width: 50%; float: left; resize:none; overflow:hidden;" id="telegram_bot_token"
                                    placeholder="Telegram Bot Token"></textarea>
                                <textarea rows="1" class="form-control text-center"
                                    style="width: 50%; float: right; resize:none; overflow:hidden;" id="telegram_chat_id"
                                    placeholder="Telegram Chat ID"></textarea>
                                
                                <br>
                                <select name="gate" id="gate" class="form-control"
                                    style="margin-bottom: 5px; text-align:center">
                                    <option value="gate/api.php">SK CVV Charged : $1</option>
                                </select>
                                <br>
                                                        ...
                                                        <div class="form-group snipcss0-5-49-50">
                                                            ...
                                                            <center class="snipcss0-7-51-53">
                                                                <select type="text"
																	...
																	<option value="2035"
                                                                        class="snipcss0-9-54-67 style-mUbvl"
                                                                        id="style-mUbvl">
                                                                        2035
                                                                    </option>
                                                                    <option value="2036"
                                                                        class="snipcss0-9-54-68 style-gRkEL"
                                                                        id="style-gRkEL">
                                                                        2036
                                                                    </option>
                                                                </select>
        ...
        $(document).ready(function() {
            ...
            $('.btn-play').click(function() {
                ...
                if (!sk_key || !pk_key) {
                    Swal.fire({
                        title: 'Please provide both SK Key and PK Key',
                        icon: 'error',
                        showConfirmButton: false,
                        toast: true,
                        position: 'top-end',
                ...
                line.forEach(function(data) {
                    var callBack = $.ajax({
                        url: gate + '?lista=' + data + '&sk_key=' + sk_key + '&pk_key=' + pk_key + '&sec=' + sec + '&cst=' + cst + '&telegram_bot_token=' + telegram_bot_token + '&telegram_chat_id=' + telegram_chat_id,
